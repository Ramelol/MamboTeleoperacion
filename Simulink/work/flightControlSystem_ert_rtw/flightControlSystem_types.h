...
#include "C:\ProgramData\MATLAB\SupportPackages\R2020b\toolbox\target\supportpackages\parrot\include\HAL.h"
...
#ifndef struct_tag_rqtnCHRFRVTiK8v0ImgItF
#define struct_tag_rqtnCHRFRVTiK8v0ImgItF

struct tag_rqtnCHRFRVTiK8v0ImgItF
{
  int32_T isInitialized;
  cell_wrap_flightControlSystem_T inputVarSize[5];
  real_T NumCircles;
  real32_T PrevPosition[3];
  boolean_T StartFlag;
  real32_T LookaheadDistance;
  boolean_T SelectTurnDirectionFlag;
  real_T TurnDirectionInternal;
  real32_T OrbitCenterInternal[3];
  real32_T OrbitRadiusInternal;
  uint8_T OrbitRadiusFlag;
  uint8_T LookaheadDistFlag;
  real32_T PrevResetSignal;
};

#endif                                 /*struct_tag_rqtnCHRFRVTiK8v0ImgItF*/

#ifndef typedef_uav_sluav_internal_system_OrbitFollower_flightControlSystem_T
#define typedef_uav_sluav_internal_system_OrbitFollower_flightControlSystem_T

typedef struct tag_rqtnCHRFRVTiK8v0ImgItF
  uav_sluav_internal_system_OrbitFollower_flightControlSystem_T;

#endif /*typedef_uav_sluav_internal_system_OrbitFollower_flightControlSystem_T*/

#ifndef struct_tag_NpLIOfyqLV40gOiJfS2JT
#define struct_tag_NpLIOfyqLV40gOiJfS2JT

struct tag_NpLIOfyqLV40gOiJfS2JT
{
  int32_T isInitialized;
...
#endif                                 /*struct_tag_NpLIOfyqLV40gOiJfS2JT*/
...
typedef struct tag_NpLIOfyqLV40gOiJfS2JT
