...
// public Button ResetButton;
    ...
    protected override void Start() {
        ...
        //changeStateCount = 0;
        moveScript = GameObject.Find("MoveController").gameObject.GetComponent<moveController>();
    }
    ...
    public void OnBeginDrag (int modelIndex) {
        if (_isTracking) {
            ...
            Vector3 modelRotation = new Vector3(0.0f, -90.0f, 0.0f);
    ...
    private void SetSceneActive(bool active) {
        ...
        foreach (var model in _activeModels) {
            if (model && model.GetHashCode() == moveScript.droneCode) {
